    ...
    <footer className="bg-brand-dark border-t border-white/5">
      <div className="container mx-auto px-4 max-w-6xl py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {/* Brand */}
          <div>
            <Link href={`/${locale}`} className="flex items-center gap-3 mb-4 w-fit">
              <div className="relative w-12 h-12 rounded-full ring-2 ring-brand-red/50">
                <Image src="/images/logo.png" alt="Atlas Albany Logo" fill className="object-contain" />
              </div>
              <div>
                <span className="block text-lg font-bold text-white leading-none">ATLAS</span>
                <span className="block text-sm font-bold text-brand-red leading-none tracking-widest">ALBANY</span>
              </div>
            </Link>
